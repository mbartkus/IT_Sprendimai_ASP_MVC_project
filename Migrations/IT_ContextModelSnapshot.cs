...
namespace IT_Sprendimai.Migrations
{
    ...
    partial class IT_ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IT_Sprendimai.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2021, 8, 18, 6, 6, 5, 434, DateTimeKind.Utc).AddTicks(6537),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("IT_Sprendimai.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("IT_Sprendimai.Data.Entities.Order", b =>
                {
                    b.HasOne("IT_Sprendimai.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IT_Sprendimai.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
